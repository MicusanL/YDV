...
(() => {
  ...
  var $ = (e, t, n) => (
    ...
    Me = (e) => na(In({}, "__esModule", { value: !0 }), e);
  var Fr = f(() => {
    "use strict";
    window.tram = (function (e) {
      ...
      function i(c, h, y) {
        return (
          "#" + ((1 << 24) | (c << 16) | (h << 8) | y).toString(16).slice(1)
        );
      }
      function o() {}
      function a(c, h) {
      ...
      var p = (function (c, h, y) {
          ...
          function X(H, te) {
            ...
            return (
              ...
              (N.open = function (fe) {
                if (
                  ((j = {}),
                  x(fe) ? (j = fe.call(N, Ne, oe, N, H)) : T(fe) && (j = fe),
                  T(j))
                )
        ...
        d = {
          ease: [
            ...
            function (c, h, y, T) {
              ...
              return (
                h +
                y * (-2.75 * S * x + 11 * x * x + -15.5 * S + 8 * x + 0.25 * c)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (c, h, y, T) {
              ...
              return (
                h +
                y * (0.3 * S * x + -1.6 * x * x + 2.2 * S + -1.8 * x + 1.9 * c)
              );
            },
          ],
          "ease-in-out": [
        ...
        q = function (c) {
          ...
          for (h = 0; h < _.length; h++)
            if (((y = _[h] + T), y in C.style))
              return { dom: y, css: w[h] + c };
        },
        M = (t.support = {
        ...
        z = p(function (c) {
          ...
          (c.init = function (S, X, H, te) {
            ...
            H[2] && (N = H[2]),
              ...
              (this.ease = y(X[2], this.ease, x.ease)),
          ...
          (c.init = function () {
            ...
            (c.values = function (T) {
              var x,
                S = {};
              return (
                y.call(this, T, function (X, H, te) {
                  (S[X] = H),
                    this.current[X] === void 0 &&
                      ((x = 0),
                      ~X.indexOf("scale") && (x = 1),
                      (this.current[X] = this.convert(x, te)));
                }),
                S
              );
            });
          ...
          (c.init = function (y) {
            ...
            (c.render = function (y) {
              ...
              for (T = S; T--; )
                (x = this.tweens[T]),
                  x.context &&
                    (x.render(y), (this.current[x.name] = x.value), (X = !0));
              return X
      ...
      (t.fallback = function (c) {
        ...
        (t.delay = function (c, h, y) {
          return new vn({ complete: h, duration: c, context: y });
        }),
      ...
      var lt = e.style,
        Jo = e.css,
        ea = { transform: M.transform && M.transform.css },
        Dr = {
          color: [be, P],
        ...
        (e.debounce = function (_, w, q) {
          var M,
            ...
            Ke = function () {
              var le = e.now() - J;
              le < w
                ? (M = setTimeout(Ke, w - le))
                : ((M = null), q || ((Te = _.apply(k, W)), (k = W = null)));
            };
          return function () {
...
` +
  ...
  var $e = f((sF, da) => {
    ...
    function sa(e) {
      Z.env() &&
        (De(e.design) && Re.on("__wf_design", e.design),
        De(e.preview) && Re.on("__wf_preview", e.preview)),
        De(e.destroy) && Re.on("__wf_destroy", e.destroy),
        e.ready && De(e.ready) && ME(e);
    }
    function ME(e) {
      if (An) {
        e.ready();
    ...
    function ua(e) {
      De(e.design) && Re.off("__wf_design", e.design),
        De(e.preview) && Re.off("__wf_preview", e.preview),
        De(e.destroy) && Re.off("__wf_destroy", e.destroy),
        e.ready && De(e.ready) && DE(e);
    }
    function DE(e) {
    ...
    var qr;
    ca &&
      NE.on("touchstart mousedown", function (e) {
        qr = e.target;
      });
    Z.validClick = ca
      ? function (e) {
    ...
    function fa() {
      nt && (nt.reject(), Re.off("load", nt.resolve)),
        (nt = new Ye.Deferred()),
        Re.on("load", nt.resolve);
    }
  ...
  var Aa = f((fF, Ta) => {
    ...
    var Ur = window.jQuery,
      ...
      Sn = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), Ur(t).triggerHandler(Fe.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), Ur(t).triggerHandler(Fe.types.OUTRO));
        },
      };
    Fe.triggers = {};
    Fe.types = { INTRO: "w-ix-intro" + Ia, OUTRO: "w-ix-outro" + Ia };
    Fe.init = function () {
  ...
  var xa = f((dF, Oa) => {
    ...
    On.triggers = {};
    On.types = { INTRO: "w-ix-intro" + Sa, OUTRO: "w-ix-outro" + Sa };
  ...
  var $r = f((kt) => {
    ...
    var ja = (kt.ActionTypes = { INIT: "@@redux/INIT" });
    function $a(e, t, n) {
      var r;
      if (
  ...
  var Ja = f((Jr) => {
    ...
    function Py(e) {
      Object.keys(e).forEach(function (t) {
        var n = e[t],
          r = n(void 0, { type: Qa.ActionTypes.INIT });
        if (typeof r > "u")
          throw new Error(
            'Reducer "' +
              t +
  ...
  var Ce,
    ...
    ai = ne(() => {
      ...
      (Ce = {
        ...
        (oi = { ELEMENT: "ELEMENT", CLASS: "CLASS", PAGE: "PAGE" }),
        (qe = { ELEMENT: "ELEMENT", VIEWPORT: "VIEWPORT" }),
        (Qy = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" }),
        (Zy = {
          CHILDREN: "CHILDREN",
          SIBLINGS: "SIBLINGS",
  ...
  var cm,
    ...
    os = ne(() => {
      "use strict";
      (cm = "IX2_RAW_DATA_IMPORTED"),
        (lm = "IX2_SESSION_INITIALIZED"),
        (fm = "IX2_SESSION_STARTED"),
        (dm = "IX2_SESSION_STOPPED"),
        (pm = "IX2_PREVIEW_REQUESTED"),
        (gm = "IX2_PLAYBACK_REQUESTED"),
        (hm = "IX2_STOP_REQUESTED"),
        (Em = "IX2_CLEAR_REQUESTED"),
        (ym = "IX2_EVENT_LISTENER_ADDED"),
        (mm = "IX2_EVENT_STATE_CHANGED"),
        (vm = "IX2_ANIMATION_FRAME_CHANGED"),
        (_m = "IX2_PARAMETER_CHANGED"),
        (Im = "IX2_INSTANCE_ADDED"),
        (Tm = "IX2_INSTANCE_STARTED"),
        (Am = "IX2_INSTANCE_REMOVED"),
        (bm = "IX2_ELEMENT_STATE_CHANGED"),
        (Sm = "IX2_ACTION_LIST_PLAYBACK_CHANGED"),
        (Om = "IX2_VIEWPORT_WIDTH_CHANGED"),
        (xm = "IX2_MEDIA_QUERIES_DEFINED"),
        (Rm = "IX2_TEST_FRAME_RENDERED");
    });
  var ce = {};
  me(ce, {
    ABSTRACT_NODE: () => Ov,
  ...
  var Pv,
    ...
    cs = ne(() => {
      "use strict";
      ve();
      ({ IX2_RAW_DATA_IMPORTED: Pv } = se),
        (us = (e = Object.freeze({}), t) => {
          switch (t.type) {
            case Pv:
  ...
  var Rs,
    ...
    Cs = ne(() => {
      ...
      (Rs = $(Et())),
        ...
        (Xv = { preview: {}, playback: {}, stop: {}, clear: {} }),
  ...
  var Wt = f((e2, qs) => {
    var Jv = Mn();
    function e_(e, t) {
      for (var n = e.length; n--; ) if (Jv(e[n][0], t)) return n;
      return -1;
    }
    qs.exports = e_;
  });
  ...
  var Wn = f((vq, yl) => {
    var Ii = ol(),
      ...
      Bb = At(Si),
      it = El;
    ((Ii && it(new Ii(new ArrayBuffer(1))) != hl) ||
      (Ti && it(new Ti()) != fl) ||
      (Ai && it(Ai.resolve()) != dl) ||
      (bi && it(new bi()) != pl) ||
      (Si && it(new Si()) != gl)) &&
  ...
  var Sl = f((_q, bl) => {
    ...
    function Yb(e, t, n, r, i, o) {
      ...
      if (d && !g)
        return (
          o || (o = new Oi()),
          a || zb(e) ? Hb(e, t, n, r, i, o) : kb(e, t, u, n, r, i, o)
        );
      if (!(n & Kb)) {
  ...
  var Kn = f((Rq, Gl) => {
    ...
    function _0(e, t) {
      ...
      return n == "number" ||
        ...
        y0(e)
        ? !0
        : v0.test(e) || !m0.test(e) || (t != null && e in Object(t));
    }
    Gl.exports = _0;
  });
  var Ul = f((wq, Vl) => {
  ...
  var Gf,
    ...
    er = ne(() => {
      ...
      (Gf = $(Fi())),
        ...
        (qf = et.split("transform")[0]),
        (Jn = qf ? qf + "TransformStyle" : "transformStyle");
    });
  var Gi = f((r1, kf) => {
    var uO = 4,
      cO = 0.001,
  ...
  var rn,
    ...
    Xi = ne(() => {
      ...
      (rn = $(Gi())),
        (He = 1.70158),
        (hO = (0, rn.default)(0.25, 0.1, 0.25, 1)),
        (EO = (0, rn.default)(0.42, 0, 1, 1)),
        (yO = (0, rn.default)(0, 0, 0.58, 1)),
        (mO = (0, rn.default)(0.42, 0, 0.58, 1));
    });
  var zf = {};
  me(zf, {
    applyEasing: () => JO,
  ...
  function jf(e, t, n, r, i) {
    let o =
      n === ex ? (0, St.getIn)(i, ["config", "target", "objectId"]) : null;
          ...
          switch (t.type) {
            ...
            case lx: {
              let {
                ...
                u = e;
              return (
                (0, St.getIn)(u, [n, r]) !== r && (u = jf(u, r, a, n, o)),
                Ui(u, n, s, i, o)
              );
            }
            case fx: {
            ...
            if (p != null) {
              if ((l.isPlaying || l.play(a, !1), ki in s || Wi in s)) {
                ...
                (E !== d.fit || I !== d.alignment) &&
                  (l.layout = d.copyWith({ fit: E, alignment: I }));
              }
              for (let d in s) {
  ...
  var Qi,
    ...
    ro = ne(() => {
      ...
      (at = (e) => (t) => {
        ...
        (Zi = at("getPluginConfig")),
        (Ji = at("getPluginOrigin")),
        (aR = at("getPluginDuration")),
        (eo = at("getPluginDestination")),
        (sR = at("createPluginInstance")),
        (to = at("renderPlugin")),
        (no = at("clearPlugin"));
    });
  var sd = f((g1, ad) => {
  ...
  var Ad = f((A1, Td) => {
    ...
    function NR(e, t, n) {
      ...
      return (
        n !== void 0 &&
          ((i = CR(n)), (i = n < 0 ? PR(r + i, 0) : LR(i, r - 1))),
        RR(e, wR(t, 3), i, !0)
      );
    }
    Td.exports = NR;
  ...
  function ow({ events: e, actionLists: t, site: n } = {}) {
    let r = (0, cr.default)(
        e,
        (a, s) => {
          let { eventTypeId: u } = s;
  ...
  function sw({ store: e, select: t, onChange: n, comparator: r = aw }) {
  ...
  function fo({
    ...
    if (
      (D
        ? ((F = R.limitAffectedElements), (G = B), (U = s(R)))
        : (G = U = s({ id: v, selector: m, selectorGuids: O })),
      t && P)
    ) {
      let C = n && (U || P === !0) ? [n] : u(B);
      if (U) {
  ...
  function uw({ element: e, actionItem: t }) {
    if (!Pe) return {};
  ...
  function fw(e, t = {}, n = {}, r, i) {
    ...
    switch (r.actionTypeId) {
      ...
      case Gd:
        return { value: (0, ke.default)(parseFloat(o(e, sr)), 1) };
      case Ct: {
        let s = o(e, Xe),
          u = o(e, Ve),
          l,
        ...
        return (
          r.config.widthUnit === tt
            ? (l = Pd.test(s) ? parseFloat(s) : parseFloat(n.width))
            : (l = (0, ke.default)(parseFloat(s), parseFloat(n.width))),
          r.config.heightUnit === tt
            ? (g = Pd.test(u) ? parseFloat(u) : parseFloat(n.height))
      ...
      case fr:
        return { value: (0, ke.default)(o(e, ur), n.display) };
      case JR:
  ...
  function hw({ element: e, actionItem: t, elementApi: n }) {
  ...
  function Sw({ actionTypeId: e }, { xValue: t, yValue: n, zValue: r }) {
    return (
      (e === xt && r !== void 0) ||
      (e === Rt && r !== void 0) ||
  ...
  function Cw({ element: e, actionTypeId: t, computedStyle: n, getStyle: r }) {
    let i = lo[t],
      o = r(e, i),
      a = xw.test(o) ? o : n[i],
      s = ww(Rw, a).split(cn);
  ...
  function Nw({ store: e, elementApi: t }) {
    ...
    Object.keys(r).forEach((o) => {
      let a = r[o],
        ...
        { actionListId: u } = s,
        l = i[u];
      l && Ld({ actionList: l, event: a, elementApi: t });
    }),
      Object.keys(i).forEach((o) => {
        Ld({ actionList: i[o], elementApi: t });
      });
  }
    ...
    r &&
      ...
      i &&
        i.forEach((o) => {
          ...
          a.forEach((s) => {
            Nd({ actionGroup: s, event: t, elementApi: n });
          });
        });
  }
  function Nd({ actionGroup: e, event: t, elementApi: n }) {
    ...
    r.forEach((i) => {
      ...
      ot(o)
        ? (s = (u) => no(o)(u, i))
        : (s = Hd({ effect: Dw, actionTypeId: o, elementApi: n })),
        fo({ config: a, event: t, elementApi: n }).forEach(s);
    });
  }
  function Mw(e, t, n) {
    ...
    i(e, Ot) && Hd({ effect: Bd, actionTypeId: o, elementApi: n })(e);
  }
  function Dw(e, t, n) {
    let { setStyle: r } = n;
  ...
  function qw({ actionList: e, actionItemId: t, rawData: n }) {
    let { actionItemGroups: r, continuousParameterGroups: i } = e,
      o = [],
      a = (s) => (
  ...
  var ke,
    ...
    zd = ne(() => {
      ...
      ({
        ...
        (Xd = (e) => e.trim()),
        (lo = Object.freeze({ [Pt]: Dd, [Lt]: jR, [Nt]: YR })),
        (Vd = Object.freeze({
          [et]: XR,
          [Dd]: GR,
          [sr]: sr,
      ...
      (Pd = /px/),
        (cw = (e, t) =>
          t.reduce(
            (n, r) => (n[r.type] == null && (n[r.type] = mw[r.type]), n),
            e || {}
          )),
        (lw = (e, t) =>
          t.reduce(
            (n, r) => (
              n[r.type] == null &&
                (n[r.type] = vw[r.type] || r.defaultValue || 0),
              n
            ),
            e || {}
          ));
      (dw = (e, t) => (t && (e[t.type] = t.value || 0), e)),
        (pw = (e, t) => (t && (e[t.type] = t.value || 0), e)),
        (gw = (e, t, n) => {
      ...
      (po = {
        ...
        (vw = Object.freeze({ wght: 0, opsz: 0, wdth: 0, slnt: 0 })),
        (_w = (e, t) => {
    ...
    $d = ne(() => {
      ...
      (pr = $(ut())),
        ...
        (aC = (e, t) => {
          ...
          return (0, We.merge)(e, { position: m, current: D });
        }),
        (sC = (e, t) => {
          let {
              active: n,
          ...
          switch (t.type) {
            ...
            case Zw: {
              ...
              return (0, We.set)(e, n, {
                ...
                skipToValue: F,
                customEasingFn:
                  Array.isArray(_) && _.length === 4 ? nC(_) : void 0,
              });
            }
            case Jw: {
  ...
  var Jd,
    ...
    np = ne(() => {
      ...
      $d();
      Zd();
      ({ ixElements: fC } = ep.IX2ElementsReducer),
        (dC = (0, Jd.combineReducers)({
          ixData: us,
          ixRequest: ws,
          ixSession: Ls,
          ixElements: fC,
  ...
  var Rp = f((Q1, xp) => {
    ...
    function uP(e, t, n) {
      var r = e[t];
      (!(sP.call(e, t) && oP(r, n)) || (n === void 0 && !(t in e))) &&
        iP(e, t, n);
    }
    xp.exports = uP;
  });
  ...
  var lg = f((gG, cg) => {
    ...
    function wL(e, t, n) {
      ...
      return (
        ...
        OL(e, t, { leading: r, maxWait: t, trailing: i })
      );
    }
    cg.exports = wL;
  });
  ...
  var fg,
    ...
    yr = ne(() => {
      ...
      (fg = $(ut())),
        ...
        ({ reifyState: $L } = fg.IX2VanillaUtils),
        (Io = (e) => ({ type: CL, payload: { ...$L(e) } })),
        (To = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
          type: PL,
        ...
        (JL = (e) => ({ type: FL, payload: { actionListId: e } })),
        (eN = () => ({ type: qL })),
        (gr = (e, t) => ({
          type: GL,
          payload: { target: e, listenerParams: t },
        })),
        (tN = (e = 1) => ({ type: XL, payload: { step: e } })),
        (So = (e, t) => ({ type: VL, payload: { stateKey: e, newState: t } })),
        (hr = (e, t) => ({ type: UL, payload: { now: e, parameters: t } })),
        (Dt = (e, t) => ({ type: BL, payload: { key: e, value: t } })),
        (Oo = (e) => ({ type: HL, payload: { ...e } })),
        (Er = (e, t) => ({ type: kL, payload: { instanceId: e, time: t } })),
        (xo = (e) => ({ type: WL, payload: { instanceId: e } })),
        (Ro = (e, t, n, r) => ({
          type: zL,
  ...
  function Lo({ id: e, selector: t }) {
    if (e) {
      let n = e;
      if (e.indexOf(pg) !== -1) {
        let r = e.split(pg),
          i = r[0];
        if (((n = r[1]), i !== document.documentElement.getAttribute(hg)))
          return null;
      }
  ...
  function uN(e) {
    return e == null || e === document.documentElement.getAttribute(hg)
      ? document
      : null;
  }
  function cN(e, t) {
  ...
  var gg,
    ...
    Eg = ne(() => {
      ...
      gg = $(ut());
      ve();
      ({ ELEMENT_MATCHES: Po } = gg.IX2BrowserSupport),
        ({
          IX2_ID_DELIMITER: pg,
          HTML_ELEMENT: nN,
          PLAIN_OBJECT: rN,
  ...
  var Mg = f((bG, Ng) => {
    ...
    function xN(e, t, n) {
      return (
        (t = Lg(t === void 0 ? e.length - 1 : t, 0)),
        function () {
          for (
            var r = arguments, i = -1, o = Lg(r.length - t, 0), a = Array(o);
            ++i < o;
  ...
  var qo = f((MG, nh) => {
    ...
    function $N(e) {
      for (
        var t = e.name + "", n = th[t], r = YN.call(th, t) ? n.length : 0;
        r--;
  ...
  var sh = f((qG, ah) => {
    ...
    function iM(e) {
      ...
      return (
        (t.__actions__ = rM(e.__actions__)),
    ...
    function SM(e) {
      return yM(function (t) {
        ...
        for (r = a ? r : n; ++r < n; ) {
          ...
          !u[4].length &&
          u[9] == 1
            ? (a = a[Go(u[0])].apply(a, u[3]))
            : (a = o.length == 1 && gh(o) ? a[s]() : a.thru(o));
        }
        return function () {
          var l = arguments,
            g = l[0];
  ...
  var Th = f((HG, Ih) => {
    ...
    function CM(e, t, n) {
      return (
        ...
        n !== void 0 && ((n = Xo(n)), (n = n === n ? n : 0)),
        t !== void 0 && ((t = Xo(t)), (t = t === t ? t : 0)),
        wM(Xo(e), t, n)
      );
    }
    Ih.exports = CM;
  ...
  var Ph,
    ...
    Wh = ne(() => {
      ...
      (Mh = $(ut())),
        ...
        (Vo = "COMPONENT_ACTIVE"),
        (Xh = "COMPONENT_INACTIVE"),
        ({ COLON_DELIMITER: Ah } = ce),
        ({ getNamespacedParameterId: bh } = Mh.IX2VanillaUtils),
        (Vh = (e) => (t) => typeof t == "object" && e(t) ? !0 : t),
        (hn = Vh(({ element: e, nativeEvent: t }) => e === t.target)),
        (ZM = Vh(({ element: e, nativeEvent: t }) => e.contains(t.target))),
        (Ue = (0, Ph.default)([hn, ZM])),
        (Uh = (e, t) => {
          if (t) {
            let { ixData: n } = e.getState(),
              { events: r } = n,
        ...
        (Bo = { types: Uo }),
        (eD = { PAGE_START: Gh, PAGE_FINISH: qh }),
        (gn = (() => {
        ...
        (Hh = (e) => (t, n) => {
          let { type: r } = t.nativeEvent,
            i = [Vo, Xh].indexOf(r) !== -1 ? r === Vo : n.isActive,
            o = { ...n, isActive: i };
          return ((!n || o.isActive !== n.isActive) && e(t, o)) || o;
        }),
        (Oh = (e) => (t, n) => {
          let r = { elementHovered: nD(t) };
          return (
        ...
        (br = (e = !0) => ({
          ...
          handler: Le(
            e ? Ue : hn,
            Hh((t, n) => (n.isActive ? En.handler(t, n) : n))
          ),
        })),
        (Sr = (e = !0) => ({
          ...Bh,
          handler: Le(
            e ? Ue : hn,
            Hh((t, n) => (n.isActive ? n : En.handler(t, n)))
          ),
        })),
        (wh = {
          ...Bo,
        ...
        (kh = {
          ...
          [UM]: br(),
          [BM]: Sr(),
          [$M]: { types: "ecommerce-cart-open", handler: Le(Ue, Ie) },
          [YM]: { types: "ecommerce-cart-close", handler: Le(Ue, Ie) },
          [PM]: {
            types: "click",
            handler: Le(
              Ue,
            ...
            handler: (
              ...
              switch (a) {
                ...
                case qe.PAGE: {
                  ...
                  m = v ? Math.min(P + E, R) / R : Math.min(L + I, D) / D;
                  break;
                }
                case qe.ELEMENT:
                default: {
                  ...
                  if (P && Ue({ element: t, nativeEvent: r }) !== !0) break;
                  let L = t.getBoundingClientRect(),
                    { left: R, top: D, width: F, height: G } = L;
                  if (!P && !oD({ left: p, top: d }, L)) break;
                  (A = !0), (m = v ? (p - R) / F : (d - D) / G);
                  break;
                }
              }
              return (
                b && (m > 1 - Ch || m < Ch) && (m = Math.round(m)),
                (a !== qe.ELEMENT || A || A !== o.elementHovered) &&
                  ((m = l ? 1 - m : m), e.dispatch(Dt(O, m))),
                {
                  elementHovered: A,
                  clientX: p,
                  clientY: d,
          ...
          [jM]: {
            ...
            handler: (
              ...
              if (g === qe.VIEWPORT) {
                let P = A ? o / s : a / u;
                return (
                  P !== i.scrollPercent && t.dispatch(Dt(d, P)),
                  { scrollPercent: P }
                );
              } else {
                let P = bh(r, d),
                ...
                return (
                  _ !== i.scrollPercent && t.dispatch(Dt(P, _)),
                  { scrollPercent: _ }
                );
              }
            },
  ...
  function xD(e) {
    ct({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: CD }),
      ct({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: PD }),
      ct({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: LD }),
      ct({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: ND });
  }
  function RD(e) {
    ct({
      store: e,
  ...
  function CD({ rawData: e, defer: t }, n) {
    let r = () => {
      Pr({ store: n, rawData: e, allowEvents: !0 }), nE();
    };
    t ? setTimeout(r, 0) : r();
  }
  function nE() {
  ...
  function PD(e, t) {
    ...
    if (r && i && g && s) {
      ...
      p && (g = ED({ actionList: p, actionItemId: i, rawData: g }));
    }
    if (
      ...
      qt({ store: t, actionListId: r }),
        iE({ store: t, actionListId: r, eventId: o });
      let p = yn({
        store: t,
        eventId: o,
        actionListId: r,
  ...
  function LD({ actionListId: e }, t) {
    e ? qt({ store: t, actionListId: e }) : oE({ store: t }), Lr(t);
  }
  function ND(e, t) {
    Lr(t), tE({ store: t, elementApi: he });
  }
  function Pr({ store: e, rawData: t, allowEvents: n, testManual: r }) {
    ...
    t && e.dispatch(Io(t)),
      i.active ||
        ...
        n &&
          (XD(e), MD(), e.getState().ixSession.hasDefinedMediaQueries && RD(e)),
        e.dispatch(Ao()),
        DD(e, r));
  }
  function MD() {
  ...
  function DD(e, t) {
    let n = (r) => {
      ...
      i.active &&
        (e.dispatch(hr(r, o)), t ? wD(e, n) : requestAnimationFrame(n));
    };
  ...
  function FD({ target: e, listenerParams: t }) {
      ...
      R.forEach((D) => {
        ...
        if (((v[B] = GD(v[B], L, D)), !I[B])) {
          ...
          Rr({
            ...
            b.push({ element: _, key: B });
          });
        }
      });
    }),
      b.forEach(({ element: P, key: L }) => {
        let R = v[L],
          ...
          U = (
            ...
            ? Ko(F)(P, D)
            : null,
          B = zo({ element: P, actionItem: D, elementApi: he }, U);
        jo({
          store: e,
          element: P,
          eventId: r,
  ...
  function WD({ logic: e, store: t, events: n }) {
    zD(n);
    ...
    (0, Gt.default)(s, (p, d) => {
      let E = n[d],
        { action: I, id: v, mediaQueries: b = o.mediaQueryKeys } = E,
        { actionListId: m } = I.config;
      TD(b, o.mediaQueryKeys) || t.dispatch(Co()),
        I.actionTypeId === pe.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(E.config) ? E.config : [E.config]).forEach((A) => {
            let { continuousParameterGroupId: P } = A,
              L = (0, ze.default)(a, `${m}.continuousParameterGroups`, []),
              R = (0, jh.default)(L, ({ id: G }) => G === P),
              D = (A.smoothing || 0) / 100,
        ...
        (I.actionTypeId === pe.GENERAL_START_ACTION || ko(I.actionTypeId)) &&
          iE({ store: t, actionListId: m, eventId: v });
    });
    let u = (p) => {
        ...
        HD(s, (E, I, v) => {
          ...
          O.actionTypeId === pe.GENERAL_CONTINUOUS_ACTION
            ? (Array.isArray(b.config) ? b.config : [b.config]).forEach(P)
            : P();
        });
      },
      l = (0, Jh.default)(u, OD),
  ...
  function iE({ store: e, actionListId: t, eventId: n }) {
        ...
        let { config: d, actionTypeId: E } = p,
          I =
            d?.target?.useEventTarget === !0 && d?.target?.objectId == null
              ...
              : d,
          v = Rr({ config: I, event: s, elementApi: he }),
          b = Cr(E);
        v.forEach((m) => {
          let O = b ? Ko(E)(m, p) : null;
          jo({
            destination: zo({ element: m, actionItem: p, elementApi: he }, O),
            immediate: !0,
            store: e,
            element: m,
            eventId: n,
  ...
  function oE({ store: e }) {
    ...
    (0, Gt.default)(t, (n) => {
      if (!n.continuous) {
        ...
        Yo(n, e), i && e.dispatch(Ft({ actionListId: r, isPlaying: !1 }));
      }
    });
  }
  function qt({
  ...
  function yn({
    ...
    let { ixData: u, ixSession: l } = e.getState(),
      ...
      E = (0, ze.default)(u, `actionLists.${i}`, {}),
      { actionItemGroups: I, useFirstGroupAsInitialState: v } = E;
    if (!I || !I.length) return !1;
    o >= I.length && (0, ze.default)(p, "config.loop") && (o = 0),
      o === 0 && v && o++;
    let m =
        (o === 0 || (o === 1 && v)) && ko(p.action?.actionTypeId)
          ? p.config.delay
          : void 0,
    ...
    return (
      O.forEach((R, D) => {
        ...
        Rr({
          ...
          L = !0;
          let k = P === D && q === 0,
            J = gD({ element: w, actionItem: R }),
            Te = zo({ element: w, actionItem: R, elementApi: he }, M);
          jo({
            store: e,
            element: w,
            actionItem: R,
  ...
  function jo(e) {
    let { store: t, computedStyle: n, ...r } = e,
      ...
      p = !u,
      d = fD(),
      { ixElements: E, ixSession: I, ixData: v } = t.getState(),
      b = lD(E, i),
      { refState: m } = E[b] || {},
      O = Mo(i),
      A = I.reducedMotion && si[o.actionTypeId],
      P;
    if (A && u)
    ...
    if (
      ...
      aE(document.body, "ix2-animation-started", d),
      a)
    ) {
      KD(t, d);
      return;
    }
    ct({ store: t, select: ({ ixInstances: R }) => R[d], onChange: sE }),
  ...
  function sE(e, t) {
    let {
      ...
      { events: L } = A,
      R = L && L[p] ? L[p] : {},
      { mediaQueries: D = A.mediaQueryKeys } = R;
    if (wr(D, P.mediaQueryKey) && (r || n || i)) {
      ...
      if (i) {
        if (v) {
          ...
          m && !F && t.dispatch(Ft({ actionListId: I, isPlaying: !1 }));
        }
        Yo(e, t);
      }
    }
  ...
  var jh,
    ...
    Ho = ne(() => {
      ...
      (uD = Object.keys(xn)),
        ...
        (Kh = navigator.userAgent),
        (SD = Kh.match(/iPad/i) || Kh.match(/iPhone/)),
        (OD = 12);
      VD = ["resize", "orientationchange"];
      (BD = (e, t) => (0, $h.default)((0, Zh.default)(e, t), Qh.default)),
        (HD = (e, t) => {
          (0, Gt.default)(e, (n, r) => {
            n.forEach((i, o) => {
              let a = r + Wo + o;
        ...
        (kD = (e) => {
          ...
          return Rr({ config: t, elementApi: he });
        });
    });
  var fE = f((Qo) => {
    "use strict";
    ...
    function tF(e) {
      lE(), (0, $o.startEngine)({ store: Nr, rawData: e, allowEvents: !0 });
    }
    function lE() {
      (0, $o.stopEngine)(Nr);
    }
          ...
          if (!m.getAttribute("hreflang")) {
            ...
            if (((s.href = O), !(O.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var P = e(s.hash);
                P.length && p.push({ link: A, sec: P, active: !1 });
                return;
              }
              if (!(O === "#" || O === "")) {
                var L =
        ...
        function R(C, _) {
          ...
          if (w !== q) {
            var M = F(C, w, q),
              ...
              k = function () {
                var J = Date.now() - W;
                window.scroll(0, G(w, q, J, M)),
                  J <= M ? s(k) : typeof _ == "function" && _();
              };
            s(k);
          }
        }
      ...
      (_E.exports = function (e) {
        ...
        function r(o) {
          ...
          function p(b) {
            ...
            (m && m.length > 1) ||
              ((a = !0),
              m ? ((s = !0), (l = m[0].clientX)) : (l = b.clientX),
              (g = l));
          }
          function d(b) {
            if (a) {
              ...
              (g = O),
                Math.abs(A) > u &&
                  n &&
                  String(n()) === "" &&
                  (i("swipe", b, { direction: A > 0 ? "right" : "left" }), I());
            }
          }
          function E(b) {
...
Webflow.require("ix2").init({
  events: {
    "e-7": {
      ...
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776ade1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776adeb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-19": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776adee",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776adf1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-23": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776adde",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-25": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776ade4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-29": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|9296e7c2-6557-5d90-3fa3-42eed30d8fd5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-31": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|181676bf-0c16-ffab-e529-b6455fadfa85",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-33": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|0cb9389a-e5a5-62b7-9d04-edbbc7c4fcf9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-35": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|62fcd2da-c779-a2d1-9f8e-2a6a2ed8a2cf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-37": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|2b09a706-323d-95cd-b1ef-1225fbae3208",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-39": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|e1e8c4eb-0322-8ea4-2ddf-7f7e67a7a968",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-41": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|c2627181-4ad8-c753-ef63-dea2d0aeb161",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-43": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|ee98d4b5-8060-d4bc-5498-2df06d12d44f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-45": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|232d360d-16c0-a259-dc65-a69d7559cced",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-47": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|1de2117b-a158-15af-1a79-a5b99fe1bfba",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-49": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|f3888817-a8d7-d8aa-869c-b3724fcb4f79",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-51": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|f3888817-a8d7-d8aa-869c-b3724fcb4f7a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-53": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|1de85940-136c-5d39-d33f-463203707c08",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-55": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|30abc767-3a7e-37d1-8a51-49a41dad9503",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-57": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|cbff2193-c71f-e2f1-47fa-968e1724c3f1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-59": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|f3e62cf9-dab4-6523-724c-ea50ed3cf208",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-61": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|2728b4ac-1a94-0d26-c083-04e690b229f6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-65": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|6ac4209b-3d86-0253-fd3c-57cb4e8c8712",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-67": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|7decaa44-1e50-528c-154a-2ad824391fb3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-69": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|04993a7c-2f4b-946d-44ea-222f4c5ab92d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-71": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|d530551e-d7a8-1413-def5-7d695076d4dd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-73": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "d85aec77-4af4-6499-4444-602ac458c4bc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-76": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|5cb7ecd3-b0d0-3ca3-6960-a4a12439d092",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-78": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|0eebadf7-2a35-76cc-fd4d-2a2304d04211",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-80": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|64170b86-e68d-2bf4-8957-42fc9ac061d1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-82": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|6c197643-c491-bb89-3abc-e7c43b7855a4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-84": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|721504a6-222b-8bf4-062e-ed6a9eaaba26",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-86": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|721504a6-222b-8bf4-062e-ed6a9eaaba2f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-88": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|0c258d60-6e5b-7bd4-69c8-7b8464a6080e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-90": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|0c258d60-6e5b-7bd4-69c8-7b8464a60810",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-92": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|15b76b49-68e9-e872-4944-682d06df1474",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-94": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|15b76b49-68e9-e872-4944-682d06df147d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-96": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|af4c6aae-55df-1172-e996-656b4afe48c5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-98": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|af4c6aae-55df-1172-e996-656b4afe48c7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-100": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|b8d54bcd-9c83-427d-4c7a-30fb3c37b56d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-102": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66ec284b322d1e7376f9e0ff|b8d54bcd-9c83-427d-4c7a-30fb3c37b576",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-120": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "be3695b7-78e4-22e1-48df-05985776ade8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-126": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|c83b1d94-b4a2-f496-54a0-8f743f76c7e7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-128": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66e7f4af9df1a44398ffd370|09c8dc80-ee78-a34d-92a7-4318338c5d7b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-129": {
      ...
      createdOn: 1728148169362,
    },
  },
  actionLists: {
    "a-9": {
      id: "a-9",
      title: "socialmediaScale-Out",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      createdOn: 1727089114751,
    },
    "a-10": {
      id: "a-10",
      title: "socialmediaScale-In",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727089155596,
    },
    a: {
      id: "a",
      title: "carusel valori",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["e9bf9e07-65e7-1e4d-9c5d-116fd0cd01bc"],
                },
                xValue: 0,
                xUnit: "%",
                yUnit: "PX",
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1726498841000,
    },
    "a-8": {
      id: "a-8",
      title: "imaginetitluHover-Out",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  id: "66e7f4af9df1a44398ffd370|adb86403-4f10-8909-d116-0eb6841428ed",
                },
                value: 0,
                unit: "",
              },
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727088235150,
    },
    "a-4": {
      id: "a-4",
      title: "scalenavbarbutton-Out",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727085858194,
    },
    "a-7": {
      id: "a-7",
      title: "scalenavbarbutton-In",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727087401115,
    },
    "a-11": {
      id: "a-11",
      title: "navbaranimation",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 1000,
                target: { id: "be3695b7-78e4-22e1-48df-05985776addc" },
                xValue: 0,
                yValue: -8,
                xUnit: "px",
                yUnit: "px",
      ...
      createdOn: 1727089252557,
    },
    "a-13": {
      id: "a-13",
      title: "desprenoiAnimatie",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".desprenoi-box",
                  selectorGuids: ["37e6a714-f6a7-1202-b4ed-ddfa5c1c33d5"],
                },
                xValue: -33,
                xUnit: "px",
                yUnit: "PX",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1727090503966,
    },
    "a-15": {
      id: "a-15",
      title: "animatievalori",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".titlu-valori",
                  selectorGuids: ["19a23ceb-3645-7551-3557-b629ad085e55"],
                },
                globalSwatchId: "",
                rValue: 66,
                bValue: 205,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".subtitlu-valori",
                  selectorGuids: ["f9ddf432-9056-337b-b342-a6d7d3a8b007"],
                },
                xValue: -33,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "66e7f4af9df1a44398ffd370|ab1f02ac-9a0d-dad9-538e-d6f4bfedfa02",
                },
                xValue: -33,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".cele3valori-box",
                  selectorGuids: ["8156b502-a713-6f3f-fd0c-46a4b32d649d"],
                },
                yValue: 57,
                xUnit: "PX",
                yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".quickstack-relative",
                  selectorGuids: ["27b64bb2-d264-a2af-da88-e92df669b054"],
                },
                yValue: -180,
                xUnit: "DEG",
                yUnit: "deg",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "66e7f4af9df1a44398ffd370|487b8998-0f16-84a6-45f3-5a3f7390c3f2",
                },
                yValue: -180,
                xUnit: "DEG",
                yUnit: "deg",
    ...
    "a-32": {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727163706863,
    },
    "a-33": {
      id: "a-33",
      title: "Scale Down Card",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1727163778273,
    },
    "a-34": {
      id: "a-34",
      title: "Scale Up Card 2",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-47": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  id: "66e7f4af9df1a44398ffd370|5a57b30a-2d57-5f29-ec55-9af3fd5441fd",
                },
                xValue: 0,
                xUnit: "deg",
                yUnit: "DEG",
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1728147206898,
    },
    "a-48": {
      id: "a-48",
      title: "Schimbare Culoare Text Rotativ",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".textrotativ",
                  selectorGuids: ["325aa139-bca3-d485-8b84-27a2f111b2f9"],
                },
                globalSwatchId: "",
                rValue: 0,
                bValue: 0,
    ...
    "a-49": {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1728148023096,
    },
    "a-50": {
      id: "a-50",
      title: "Culoare Mov Text Rotativ",
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1728148175703,
    },
    "a-51": {
      id: "a-51",
      title: "Culoare Text Rotativ Negru",
      actionItemGroups: [
        {
          actionItems: [
            {
